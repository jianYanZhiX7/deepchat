...
def get_table_reference(table_name, schema=None):
    ...
    """
    # Lazy import to avoid circular dependency
    from data_helpers import detect_active_source
    ...
    csv_tables = []
    try:
        from data_helpers import list_tables
...
def profile_external_warehouse(connection_config):
    ...
    Returns:
        ...
        schema_to_markdown().
    """
    raise ImportError('remote warehouse profiling is not bundled in this plugin; use the Cowork connector and export to CSV')
