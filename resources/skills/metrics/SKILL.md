...
description: >-
  ...
  Trigger on "/metrics", "show me the metrics", "what metrics do we track?", "how is [metric name]
  calculated?", "what's the definition of [metric]?", "list all metrics", "define conversion
  rate", "how do we measure retention?", "show me all KPIs". Also use mid-analysis to confirm a
  metric's exact definition before computing it.
---
